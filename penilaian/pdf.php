...
$pdf->Cell(5,1,'periode_ajaran','LR',0,'C',1);
$pdf->Cell(3,1,'level','LR',0,'C',1);
...
for ($j=0;$j<$i;$j++){
  ...
  $pdf->Cell(2,1,$cell[$j][0],'B',0,'L'); // kode_penilaian
  $pdf->Cell(7,1,$cell[$j][1],'B',0,'L'); // kode_siswa
  $pdf->Cell(5,1,$cell[$j][2],'B',0,'L'); // periode_ajaran
  $pdf->Cell(3,1,$cell[$j][3],'B',0,'L'); // level
