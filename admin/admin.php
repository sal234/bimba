...
<form action="" method="post" enctype="multipart/form-data">
	<table width="47%">
		<tr>
			<td width="127"><label for="kode_admin">Kode Admin</label>
			<td width="10" valign="top">:
			<td colspan="2"><b><?php echo $kode_admin; ?></b>
		</tr>
		<tr>
			<td><label for="username">Username</label>
			<td valign="top">:
			<td width="251"><input name="username" type="text" id="username" value="<?php echo $username; ?>" size="30" />
			</td>
...
";
		...
		<tr>
			...
			<td valign="top">:
			<td><input name="password" type="password" id="password" value="<?php echo $password; ?>" size="30" /></td>
		</tr>
